...
public class Jockey implements Serializable {
	...
	private List<Stat> JockeyStats;

	@Generated("SparkTools")
	private Jockey(Builder builder) {
		...
		this.JockeyStats = builder.JockeyStats;
	}
	...
	public void setStats(List<Stat> jockeyStats) {
	...
	public String toString() {
		...
		builder.append("Trainer [Name=").append(Name).append(", CurrentMeetStarts=").append(CurrentMeetStarts)
				...
				.append(", PreviousYearROI=").append(PreviousYearROI).append(", TrainerStats=").append(JockeyStats)
				.append("]");
	...
	public static final class Builder {
		...
		private int PreviousYearShows;
		private float PreviousYearROI;
		private List<Stat> JockeyStats = Collections.emptyList();
		...
		public Builder withJockeyStats(List<Stat> JockeyStats) {
			this.JockeyStats = JockeyStats;
			return this;
		}

		public Jockey build() {
			return new Jockey(this);
		}
	}
